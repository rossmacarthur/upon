...
- **`syntax`** *(disabled by default)* — Enables support for configuring
  custom delimiters in templates (see [`Engine::set_syntax`][Engine::set_syntax]) and pulls in
...
[Engine::set_syntax]: https://docs.rs/upon/latest/upon/struct.Engine.html#method.set_syntax
